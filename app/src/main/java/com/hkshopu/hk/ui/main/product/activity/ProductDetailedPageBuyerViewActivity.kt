...
import com.hkshopu.hk.ui.main.store.adapter.LikeProductAdapter
...
class ProductDetailedPageBuyerViewActivity : BaseActivity(), ViewPager.OnPageChangeListener {
    ...
    val mAdapter_likeProduct_forOtherShop = LikeProductAdapter()
    val mAdapter_likeProduct_forRecommendPro = LikeProductAdapter()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.progressBarDetailedProductForBuyer.isVisible = false
    ...
    fun initView() {
        ...
        //fake datas
//        BuyerProductsBean("推薦一", "123", 12, 24, "模範商店一")
//        mutablelist_buyerProductsBean.add()

        mAdapter_likeProduct_forOtherShop
        mAdapter_likeProduct_forRecommendPro.setData(mutablelist_buyerProductsBean)
    ...
    fun initClick() {
        ...
        binding.btnProductSpecsSelecting.setOnClickListener {
            ...
            val contentView: View =
                LayoutInflater.from(this).inflate(R.layout.dialog_fragment_bottom_sheet, null)
    ...
    private fun initViewPager() {
        ...
        runOnUiThread {
            ...
            binding.productPicsPager.adapter = ProductDetailedPageBuyerViewActivity.ImageAdapter(list)
...
//                val product_id_list = ArrayList<String>()
                try {
                    ...
                    runOnUiThread {
                        binding.progressBarDetailedProductForBuyer.isVisible = true
                    }
...
//                                }
                                ...
                                binding.rViewInventory.setLayoutManager(MyLinearLayoutManager(this@ProductDetailedPageBuyerViewActivity,false))
                                binding.rViewInventory.adapter = mAdapter
