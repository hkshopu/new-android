...
class AddDesDialogFragment : DialogFragment(), View.OnClickListener {
    companion object {
        val TAG = AddDesDialogFragment::class.java.simpleName

        /**
         * Create a new instance of MyDialogFragment, providing "num"
         * as an argument.
         */
        fun newInstance(): AddDesDialogFragment {
            val f = AddDesDialogFragment()
