...
import com.HKSHOPU.hk.Base.response.ListStatusResourceObserver
import com.HKSHOPU.hk.Base.response.StatusResourceObserver
import com.HKSHOPU.hk.Base.response.UIDataBean
import com.HKSHOPU.hk.Base.response.UIListDataBean
...
class ShopVModel : BaseViewModel() {
    ...
    val shopRecommendLiveData = MediatorLiveData<UIListDataBean<ShopRecommendBean>>()
    ...
    fun getShopRecommend(lifecycleOwner: LifecycleOwner ,userId:Int,mode:String,max_seq:Int) {
        repository.getShopRecommend(lifecycleOwner,userId,mode, max_seq)
            .subscribe(ListStatusResourceObserver(shopRecommendLiveData))
    }
