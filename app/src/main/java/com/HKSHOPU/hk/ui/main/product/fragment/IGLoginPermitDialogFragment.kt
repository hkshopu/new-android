...
class IGLoginPermitDialogFragment : DialogFragment(), View.OnClickListener {
    companion object {
        val TAG = IGLoginPermitDialogFragment::class.java.simpleName

        /**
         * Create a new instance of MyDialogFragment, providing "num"
         * as an argument.
         */
        fun newInstance(): IGLoginPermitDialogFragment {
            val f = IGLoginPermitDialogFragment()
