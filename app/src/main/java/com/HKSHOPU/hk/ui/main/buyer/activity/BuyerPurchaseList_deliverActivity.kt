        ...
        val web = Web(object : WebListener {
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    Log.d("BuyerPurchaseList_deliver", "返回資料 resStr：" + resStr)
                    Log.d("BuyerPurchaseList_deliver", "返回資料 ret_val：" + json.get("ret_val"))
                    ...
                    if(list.size > 0){
                        ...
                        runOnUiThread {
                            ...
                            binding.tvSubtotal.text = "HKD$"+list[0].subtotal.toString()
